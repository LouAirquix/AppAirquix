...
object EnvironmentDetector {
    fun detectEnvironment(labels: List<ImageLabel>): String {
        ...
        return when {
            ...
            labelNames.any { it.contains("outdoor") || it.contains("tree") || it.contains("street") || it.contains("grass") || it.contains("field") || it.contains("park") || it.contains("sky") || it.contains("car") || it.contains("lake") || it.contains("building") || it.contains("beach") || it.contains("field") || it.contains("mountain") || it.contains("garden") } -> "Outside"
            else -> "Unknown"
        }
    }
}
